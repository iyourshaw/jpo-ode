...
public class KafkaConsumerConfig {
   ...
   * and values of type {@link }. This method utilizes a {@link StringDeserializer} for
   ...
   *
   * @return a configured {@link ConsumerFactory} for {@link String} keys and {@link }
   *      values.
   */
  @Bean
  public ConsumerFactory<String, OdeMessageFrameData> odeMapDataConsumerFactory() {
   ...
   */
  @Bean
  public ConcurrentKafkaListenerContainerFactory<String, OdeMessageFrameData> odeMapDataConsumerListenerContainerFactory() {
    ConcurrentKafkaListenerContainerFactory<String, OdeMessageFrameData> factory =
        new ConcurrentKafkaListenerContainerFactory<>();
