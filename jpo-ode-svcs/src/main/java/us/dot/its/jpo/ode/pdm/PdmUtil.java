...
//import us.dot.its.jpo.asn.j2735.r2024.ProbeDataManagement.ProbeDataManagement;
...
//     */
//    public static ScopedPDU createPDU(ProbeDataManagement params) {
//        ScopedPDU pdu = new ScopedPDU();
//        pdu.setType(PDU.SET);
//
//        // Add singular items to PDU
//        VariableBinding rsuPDMSampleStart = SnmpFourDot1Protocol.getVbRsuPdmSampleStart((int)params.getSample().getSampleStart().getValue());
//        VariableBinding rsuPDMSampleEnd = SnmpFourDot1Protocol.getVbRsuPdmSampleEnd((int)params.getSample().getSampleEnd().getValue());
//        VariableBinding rsuPDMDirections = SnmpFourDot1Protocol.getVbRsuPdmDirections(params.getDirections().);
//        VariableBinding rsuPDMTermChoice = SnmpFourDot1Protocol.getVbRsuPdmTermChoice(params.getTerm());
