...
public class UdpHexDecoder {
  ...
  public static String buildJsonMapFromPacket(DatagramPacket packet)
      throws InvalidPayloadException {
    return buildJsonMessageFrameFromPacket(packet, SupportedMessageType.MAP, RecordType.mapTx, Source.RSU, GeneratedBy.UNKNOWN);
  }
  ...
  public static String buildJsonSpatFromPacket(DatagramPacket packet)
      throws InvalidPayloadException {
    return buildJsonMessageFrameFromPacket(packet, SupportedMessageType.SPAT, RecordType.spatTx, Source.RSU, GeneratedBy.UNKNOWN);
  }
  ...
  public static OdeAsn1Data buildTimFromPacket(DatagramPacket packet)
      throws InvalidPayloadException {
    return buildAsn1DataFromPacket(packet, SupportedMessageType.TIM, RecordType.timMsg, Source.RSU, GeneratedBy.UNKNOWN);
  }
  ...
  public static String buildJsonBsmFromPacket(DatagramPacket packet)
      throws InvalidPayloadException {
    OdeAsn1Data asn1Data = buildAsn1DataFromPacket(packet, SupportedMessageType.BSM, RecordType.bsmTx, Source.EV, GeneratedBy.OBU);
    ...
    ((OdeMessageFrameMetadata)asn1Data.getMetadata()).setReceivedMessageDetails(receivedMessageDetails);
    return JsonUtils.toJson(asn1Data, false);
  }
  ...
  public static String buildJsonSsmFromPacket(DatagramPacket packet)
      throws InvalidPayloadException {
    return buildJsonMessageFrameFromPacket(packet, SupportedMessageType.SSM, RecordType.ssmTx, Source.RSU, GeneratedBy.UNKNOWN);
  }
  ...
  public static String buildJsonSrmFromPacket(DatagramPacket packet)
      throws InvalidPayloadException {
    return buildJsonMessageFrameFromPacket(packet, SupportedMessageType.SRM, RecordType.srmTx, Source.RSU, GeneratedBy.UNKNOWN);
  }
  ...
  public static String buildJsonPsmFromPacket(DatagramPacket packet)
      throws InvalidPayloadException {
    return buildJsonMessageFrameFromPacket(packet, SupportedMessageType.PSM, RecordType.psmTx, Source.RSU, GeneratedBy.UNKNOWN);
  }
