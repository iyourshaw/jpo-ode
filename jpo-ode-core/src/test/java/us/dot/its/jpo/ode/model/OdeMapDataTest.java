...
public class OdeMapDataTest {
    ...
    public void serializationShouldNotAddClassProperty() {
        ...
        var deserialized = (OdeMapData)JsonUtils.fromJson(mapJson, OdeMapData.class);
        String serialized = JsonUtils.toJson(deserialized, false);
